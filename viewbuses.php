            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        <h2 class="mt-0 page-title">View Bus Schedules</h2>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <table class="table bs-table-striped-color" style="color: white; width: 150%;margin-left:-50px;">
                            ...
                            <tbody>
                                <?php 
                                    $n = 0;
                                    $query = "Select busName, busNumber,noofseats, dateofTravel, l.location as busFrom,l1.location as busTo from buses b inner join Location l on b.busFrom= l.id inner join Location l1 on b.busTo= l1.id where b.dateofTravel >= CURRENT_DATE";
