                    ...
                    <div class="col-lg-6">
                        ...
                        ?>
                            ...
                            <tbody>
                                <?php 
                                    $n = 0;
                                    $query = "Select busName, busNumber,noofseats, dateofTravel, l.location as busFrom,l1.location as busTo, seatsBooked from buses b inner join Location l on b.busFrom= l.id inner join Location l1 on b.busTo= l1.id where b.dateofTravel >= '$date' and b.busFrom='$busFrom' and b.busTo='$busTo'";
                                    $query1 = mysqli_query($con,$query);
                                    while($res = mysqli_fetch_assoc($query1)){
                                ?>
                                <tr>
