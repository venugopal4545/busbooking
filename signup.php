            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        <h2 class="mt-0 page-title">Sign Up</h2>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <form id="contactForm" method="POST" >
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="name" name='fullname' type="text" placeholder="Enter your name..." required ="required" />
                            ...
                            <!-- Phone number input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="phone" type="tel" name="phone" placeholder="7000000000" required ="required" pattern="[789][0-9]{9}"/>
...
<?php
    if(isset($_POST['signupSubmit'])){
        ...
        if(mysqli_num_rows($sql1)>=1){
            ...
            $sql = "Insert into users(`fullName`, `email`, `password`, `phoneNumber`, `userType`) values ('$fullName','$email','$password','$phone','User')";
