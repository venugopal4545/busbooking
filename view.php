                    ...
                    <div class="col-lg-6">
                        <table class="table bs-table-striped-color" style="color: white; width: 150%;margin-left:-50px;">
                            ...
                            <tbody>
                                <?php 
                                    $n = 0;
                                    $query = "SELECT bu.busName,bu.busNumber,bu.busFrom, bu.busTo,bu.dateofTravel,b.qty,b.bookedon from bookings b
                                            inner join buses bu on bu.id = b.busId";
